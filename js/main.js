...
if(swicher) {
   swicher.addEventListener('change', function() {
    content1.classList.toggle('show-content');
    content1.classList.toggle('animate');
    
    content2.classList.toggle('show-content');
    content2.classList.toggle('animate');
